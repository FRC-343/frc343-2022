...
public class ThreeBallAltAuto extends SequentialCommandGroup {
  private static final double kDriveSpeed = 1;

  public ThreeBallAltAuto(Drive drive, Intake intake, Kicker kicker, Vision vision, Hood hood, Shooter shooter,
